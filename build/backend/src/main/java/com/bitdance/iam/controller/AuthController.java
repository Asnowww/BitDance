...
public class AuthController {
    ...
    public ApiResponse<LoginResponse> setPassword(@Valid @RequestBody SetPasswordRequest body) {
        return ApiResponse.ok(authService.setPassword(CurrentUser.getId(), body.password()));
    }
