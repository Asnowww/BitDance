...
class SmsCodeServiceTest {
    ...
    void mockMode_sendAndVerify_doesNotNeedRedis() {
        SmsCodeService service = new SmsCodeService(null, null, null, true, "aliyun", "123456", 0, 5, "memory");
    ...
    void mockMode_cooldown_blocksRepeatedSend() {
        SmsCodeService service = new SmsCodeService(null, null, null, true, "aliyun", "123456", 60, 5, "memory");
